...
link:https://github.com/FunktionalIO/mason/blob/master/CODE_OF_CONDUCT.adoc[Pillars Code of Conduct].
...
Before you ask a question, it is best to search for existing link:https://github.com/FunktionalIO/mason/issues[Issues] that might help you.
In case you have found a suitable issue and still need clarification, you can write your question in this issue.
It is also advisable to search the internet for answers first.

If you then still feel the need to ask a question and need clarification, we recommend the following:

* Open an https://github.com/FunktionalIO/mason/issues/new[Issue].
...
* To see if other users have experienced (and potentially already solved) the same issue you are having, check if there is not already a bug report existing for your bug or error in the link:https://github.com/FunktionalIO/mason/issues?q=label%3Abug[bug tracker].
...
* Open an link:https://github.com/FunktionalIO/mason/issues/new[Issue].
...
* Make sure that you are using the latest version.
* Read the link:https://pillars.dev[documentation] carefully and find out if the functionality is already covered, maybe by an individual configuration.
* Perform a link:https://github.com/FunktionalIO/mason/issues[search] to see if the enhancement has already been suggested.
...
Enhancement suggestions are tracked as link:https://github.com/FunktionalIO/mason/issues[GitHub issues].
